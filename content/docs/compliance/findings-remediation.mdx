...
| **Queue**              | Severity-sorted list; selection drives the detail panel                              |
...
| Param       | Meaning                                                             |
| ----------- | ------------------------------------------------------------------- |
| `triage`    | One of `actionable`, `critical`, `missing_evidence`, `report_ready` |
...
- **Since last scan** triage slice
- Bulk acknowledge / resolve for selected findings
