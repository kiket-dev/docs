...
Strategy: [future-vision.md](../architecture/future-vision.md) · Implementation: [ai-development.md](../guides/ai-development.md)
...
Guided actions, open investigation, context bundles, and MCP parity: [ai-integration-strategy.md](../plans/roadmaps/ai-integration-strategy.md) · [ai-integration-execution.md](../plans/roadmaps/ai-integration-execution.md) · open TODO items [TODO.md § AI integration](../TODO.md#ai-integration).
