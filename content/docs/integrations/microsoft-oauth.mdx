...
description: Microsoft Oauth integration for Kiket.
---
...
OAuth for this provider is handled by the Kiket platform via `integration_credentials`, not a separate extension host.
